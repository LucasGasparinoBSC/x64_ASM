...
section .data
    ...
    ; The variable NL contains the ASCII code (0x) for settiing a new line.
    ; Variable msg2 contains the same string as msg, but adds the new line character at the end.
    msg db "Hello, world", 0
    NL  db 0xa
    msg2 db "Hello, world", 10, 0
...
; Repeat the above for NL and msg2.
...
main:             ; Label 'main' where the program starts.
    ...
    mov rax, 1    ; 1 = write
    mov rdi, 1    ; 1 = stdout
    mov rsi, NL   ; Go to next line
    mov rdx, 1    ; length of string in rdx
    syscall       ; display the string
    mov rax, 1    ; 1 = write
    mov rdi, 1    ; 1 = stdout
    mov rsi, msg2 ; string to display in rsi
    mov rdx, 13   ; length of string in rdx
    syscall       ; display the string
    mov rax, 60   ; 60 = exit
